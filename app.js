...
async function loadServiceStock() {
  ...
  try {
    ...
    if (error) {
      ...
      showStockError(
        "Service availability load nahi hui. Please refresh."
      );
    ...
    /*
      ...
      If a service has no row in service_stock,
      it will be considered OUT OF STOCK.

      This prevents customers from ordering
      a service that has not been configured.
    */
      ...
      .map(
        category => `
          ...
          <button
            ...
            onclick="selectCategory('${escapeHTML(category.id)}')">
...
document.addEventListener(
  ...
  async function () {
    ...
    /*
      First load stock from Supabase.
    */
...
function openCheckout(
  ...
  /*
    ...
    Even if someone somehow calls
    openCheckout manually, don't allow
    an out-of-stock service.
  */
...
function showPayment() {
  ...
  /*
    Stock check again before payment.
  */
...
async function awaitRefreshStock() {
...
async function submitOrder() {
  ...
  */
  ...
  if (
    ...
    alert(
      "Ye service abhi out of stock hai. Order submit nahi kiya gaya."
    );
